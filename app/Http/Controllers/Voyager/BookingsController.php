...
class BookingsController extends VoyagerBaseController
{
    ...
    public function getBookingStatusList(Request $request){
        $bookingStatus = BookingRepairerStatus::select("booking_repairer_statuses.status","booking_repairer_statuses.status_time","booking_repairer_statuses.repairer_id","repairers.first_name","repairers.last_name")
        ->leftJoin("repairers","repairers.id","=","booking_repairer_statuses.repairer_id")
        ->where("booking_repairer_statuses.booking_id",$request->bookingId)->get();
