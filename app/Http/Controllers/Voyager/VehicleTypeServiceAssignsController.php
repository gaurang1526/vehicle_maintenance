...
class VehicleTypeServiceAssignsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','VehicleBrand','Service','VehicleType'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $VehicleTypeServiceAssign = VehicleTypeServiceAssign::find($id);
        $VehicleTypeServiceAssign->vehicle_type_id = $request->vehicleType;
        $VehicleTypeServiceAssign->vehicle_brand_id = $request->multipleBrand;
        $VehicleTypeServiceAssign->save();

        $delete = VehicleBrandMultipleServiceAssign::where('vehicle_type_service_assigns_id',$id)->delete();

        if(count($request->multipleService) > 0){
            foreach ($request->multipleService as $key => $value) {
                $VehicleBrandMultipleServiceAssign = new VehicleBrandMultipleServiceAssign();
                $VehicleBrandMultipleServiceAssign->vehicle_type_service_assigns_id = $id;
                $VehicleBrandMultipleServiceAssign->service_id = $value;
    ...
    public function store(Request $request)
    {
      ...
      //  echo "<pre>";print_r($request->all());exit;
        ...
        $VehicleTypeServiceAssign = VehicleTypeServiceAssign::find($data->id);
        $VehicleTypeServiceAssign->vehicle_type_id = $request->vehicleType;
        $VehicleTypeServiceAssign->vehicle_brand_id = $request->multipleBrand;
        $VehicleTypeServiceAssign->save();
        ...
        if(count($request->multipleService) > 0){
            foreach ($request->multipleService as $key => $value) {
                $VehicleBrandMultipleServiceAssign = new VehicleBrandMultipleServiceAssign();
                $VehicleBrandMultipleServiceAssign->vehicle_type_service_assigns_id = $data->id;
                $VehicleBrandMultipleServiceAssign->service_id = $value;
                $VehicleBrandMultipleServiceAssign->save();
            }
        }
    ...
    public function relation(Request $request)
    {
     ...
     public static function testing($id){
        $data = VehicleBrandMultipleServiceAssign::where('vehicle_type_service_assigns_id',$id)->get()->toArray();  
        return $data;
    }
}
